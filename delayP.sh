...
/root/bin/ffmpeg -f image2 -i /var/www/ffmpeg/ffmpeg/tmp/foo-%04d.jpeg -r 25 -s 1080x720 -y /var/www/ffmpeg/ffmpeg/delayvideo/$vId.mp4 2>&1 | tee /var/www/ffmpeg/ffmpeg/progress/$vtxtname.txt
